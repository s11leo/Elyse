...
const Header = () => {
    return (
        ...
        <div className="div-2">
            ...
            <div className="div-8">
                <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/8a4ffdb6ee7819ce437fff3101d46f514ceacc1b0e8f290a2fba5c1bd64b8f99?" className="img-7" alt="Image 7" />
            <div className="div-9">
                <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/864207f9907234c649d0b3c570d44ab7bea6104c29bc55368f85b2d0e8988079?" className="img-8" alt="Image 8" />
                ...
                <a href="app_page/index.html">
                <button className="div-11">
                    <div className="div-12">Enter app</div>
                    <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/c0d699fabb2ab9d87f4b1e67a53067ac25397f39d676f58774088a94e8aeaa94?" className="img-9" alt="Button Image" />
                </button>
                </a>
            </div>
            </div>
